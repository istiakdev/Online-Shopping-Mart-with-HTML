...
if (isset($_POST["category"]))
{
	...
	if (mysqli_num_rows($run_query)>0)
	{
		while ($row=mysqli_fetch_array($run_query))
		{
			...
			echo "
			<li><a href='#' class ='get_selected_Category' cid='$cid'>$cat_name</a></li>
			 ";
			 ...
			 <div class='col-md-4'>
			  <div class='panel panel-info'> 
				  ...
				  <div class='panel-body'>
				    <img src='images/$pro_image' style = 'width:160px; height:250px;'/> </div>
			 ...
			 <div class='col-md-4'>
			  <div class='panel panel-info'> 
				  ...
				  <div class='panel-body'>
				    <img src='images/$pro_image' style = 'width:160px; height:250px;'/> </div>
				  <div class='panel-heading'>Tk $pro_price.00
				   <button style='float:right;' pid='$pro_id'  id='product' class='btn btn-danger btn-xs'>AddToCart</button>
				   </div>
			  </div>
			  </div> 
			  ";
...
if (isset($_POST["addProduct"]))
{
  ...
  <b>Product is alredy added into the cart</b>
</div>";
	}
	else {
...
if (isset($_POST["get_cart_product"])||  isset($_POST["cart_checkout"])  )
{
 ...
 $total_amt=0;
		...
		if (isset($_POST["get_cart_product"]))
		{
				echo "<div class = 'row'>
						     ...
						     <div class = 'col-md-3'>Tk.$pro_price</div>
						</div> ";
						$no=$no+1;
		}
		else {
 ...
 <div class = 'col-md-2'><img src = 'images/$pro_image' width='50px' height='60' ></div>
...
if (isset($_POST["removeFromCart"]))
{
	    ...
	    if($run_query)
		{
			echo "<div class='alert alert-success'>
  <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
  <b>Product is removed from the cart</b>
</div>";
		}
...
if (isset($_POST["updateProduct"]))
{
	...
	$run_query = mysqli_query($conn,$sql);
	    if($run_query)
		{
			echo "<div class='alert alert-success'>
  <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
  <b>Product is Updated to the cart</b>
</div>";
		}
